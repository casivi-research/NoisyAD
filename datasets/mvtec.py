...
class MVTecDataset(Dataset):
    ...
    def __init__(self,
        ...
        assert class_name in MVTEC_CLASS_NAMES, 'class_name: {}, should be in {}'.format(
            class_name, MVTEC_CLASS_NAMES)
        ...
        if noise_type == 'RandomBrightnessContrast':
            transform_list.insert(2, A.RandomBrightnessContrast(brightness_limit=0.3, contrast_limit=0.2, brightness_by_max=True, p=p))
